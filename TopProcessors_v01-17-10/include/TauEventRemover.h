#ifndef TauEventRemover_h
#define TauEventRemover_h 1
 ...
 * 
 * @author F. Gaede, DESY
 * @version $Id: TauEventRemover.h,v 1.4 2005-10-11 12:57:39 gaede Exp $ 
 */

class TauEventRemover : public Processor {
  
 public:
  
  virtual Processor*  newProcessor() { return new TauEventRemover ; }
