...
class FatJetProcessor : public Processor {
	...
	protected:
		...
		std::string _IsoLepColName, _FatJetColName, _FlavourJetsName, _SortingType, _HadronicFatJetConstituentsCol,_HadronicFatJetCol, _LeptonicFatJetConstituentsCol, _LeptonicFatJetCol;
		...
		ReconstructedParticle *JetA, *JetB, *HadronicJet, *LeptonicJet, *Lepton, *BJet; 
};		
#endif
