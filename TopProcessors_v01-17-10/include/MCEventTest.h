#ifndef MCEventTest_h
#define MCEventTest_h 1
 ...
 * 
 * @author F. Gaede, DESY
 * @version $Id: MCEventTest.h,v 1.4 2005-10-11 12:57:39 gaede Exp $ 
 */

class MCEventTest : public Processor {
  
 public:
  
  virtual Processor*  newProcessor() { return new MCEventTest ; }
