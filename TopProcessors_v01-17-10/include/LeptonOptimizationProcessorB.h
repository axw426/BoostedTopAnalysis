 ...
 */
#ifndef LeptonOptimizationProcessorB_h
#define LeptonOptimizationProcessorB_h 1
...
class LeptonOptimizationProcessorB : public Processor {

	public:

		virtual Processor*  newProcessor() { return new LeptonOptimizationProcessorB ; }

		LeptonOptimizationProcessorB() ;
	...
	protected:
		...
		std::vector<Float_t>  _vnCorrectLeptons,_vCorrectLeptonYN, _vPDG, _vEnergy, _vPx, _vPy, _vPz, _vPt, _vPTot, _vCharge, _vJetXt, _vJetZ;
		...
		std::vector<Float_t> _vECALToHCALFraction, _vConeEnergy, _vD0,_vZ0, _vR0, _vdEdX, _vomega, _vphi, _vtrkType, _vHighestEnergyYN, _vCalByP, _vLowestImpactParameterYN, _vHighestJetZ;
		  
		int nEvt, nReal, nFake, nLeptons, njet, nCorrectLeptons;
		...
		TTree* _tData;
		TTree* _tCorrectData;
		float	bestenergy, lowestimpactparameter, bestJetZ;
		int bestenergyposition, bestimpactparameterposition, bestJetZparameterposition;
