 ...
 */
#ifndef LeptonEfficiencyChecker_h
#define LeptonEfficiencyChecker_h 1
...
class LeptonEfficiencyChecker : public Processor {

	public:

		virtual Processor*  newProcessor() { return new LeptonEfficiencyChecker ; }

		LeptonEfficiencyChecker() ;
	...
	protected:
		...
		std::vector<Float_t> _vnLeptonFound, _vNRecoPerMC, _vLinkedRPID, _vLinkedRPEnergy;
		long int totalLeptonsFound;

		
		long int nEvt, nReal, nFake, nDuplicate, nLeptons, njet;
